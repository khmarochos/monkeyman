use utf8;
package HyperMouse::Schema::Result::ProvisioningObligationXResourcePiece;
...
=head1 TABLE: C<provisioning_obligation_x_resource_piece>

=cut

__PACKAGE__->table("provisioning_obligation_x_resource_piece");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:d3LODQ248+fUNZeBI5gSMw
