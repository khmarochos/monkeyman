use utf8;
package HyperMouse::Schema::Result::ResourceHost;
...
=head1 TABLE: C<resource_host>

=cut

__PACKAGE__->table("resource_host");
...
__PACKAGE__->has_many(
  ...
  { "foreign.resource_host_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);


# Created by DBIx::Class::Schema::Loader v0.07046 @ 2017-04-26 08:31:38
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:ny1oakmEJ+wtH5dNT1huJw
