use utf8;
package HyperMouse::Schema::Result::ServicePackage;
...
=head1 TABLE: C<service_package>

=cut

__PACKAGE__->table("service_package");
...
__PACKAGE__->has_many(
  ...
  { "foreign.service_package_id" => "self.id" },
  { cascade_copy => 0, cascade_delete => 0 },
);


# Created by DBIx::Class::Schema::Loader v0.07046 @ 2017-07-28 02:37:57
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:IDRcyQtr7bsGReIAE+Fksg
