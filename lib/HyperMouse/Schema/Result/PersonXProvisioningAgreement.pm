use utf8;
package HyperMouse::Schema::Result::PersonXProvisioningAgreement;
...
=head1 TABLE: C<person_x_provisioning_agreement>

=cut

__PACKAGE__->table("person_x_provisioning_agreement");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:2o0UPzLYd1d1fdeqX+Z2dg
