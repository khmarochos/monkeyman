use utf8;
package HyperMouse::Schema::Result::PersonXPerson;
...
=head1 TABLE: C<person_x_person>

=cut

__PACKAGE__->table("person_x_person");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OxkzyzYETr/4VCPCp6ohFA
